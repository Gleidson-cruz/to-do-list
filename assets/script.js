...
btnAdcionar.addEventListener("click", function () {
  ...
  if (inputTask.trim() !== "") {
    ...
    spanEdit.addEventListener("click", function () {
      const editContent = "<input type='text' id='editTask' class='col-11 py-0 px-1'><button id='btnEdit' class='col-1 ms-0 p-0'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-check-lg' viewBox='0 0 16 16'><path d='M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z'/>svg></button>";
    ...
    li.addEventListener("click", function () {
      ...
      li.style.background = (li.style.textDecoration === "line-through") ? "0e0f18" : "#3c3c47";
    });
    li.addEventListener("mouseover", function () {
      li.style.background = (li.style.textDecoration === "line-through") ? "#12123B": "#17182B";
    });
